	...
	<div class="row">
		...
		<div class="col-8">
			...
			<ul class="list-inline">
				<?php if ($partner['facebook']) echo '<li class="list-inline-item"><a href="'.$partner['facebook'].'" class="btn btn-primary" target="_blank" data-toggle="tooltip" title="Facebook">'.icon('fa-facebook').'</a></li>' ?>
				<?php if ($partner['twitter']) echo '<li class="list-inline-item"><a href="'.$partner['twitter'].'" class="btn btn-info" target="_blank" data-toggle="tooltip" title="Twitter">'.icon('fa-twitter').'</a></li>' ?>
				<?php if ($partner['code']) echo '<li class="list-inline-item"><span data-toggle="tooltip" title="Code promotionnel">'.icon('fa-gift').' '.$partner['code'].'</span></li>' ?>
			</ul>
