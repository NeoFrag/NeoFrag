...
<?php if ($data['total_pending']): ?>
	...
	<a href="<?php echo url('admin/recruits/pending.html'); ?>"><b><?php echo $data['total_pending'].($data['total_pending'] > 1 ? ' candidatures' : ' candidature'); ?></b></a> en <?php echo $data['total_pending'] > 1 ? 'attentes' : 'attente'; ?>
<?php else: ?>
