		...
		<div id="gallery-vignettes" class="row">
			<?php foreach ($images as $image): ?>
				<div class="gallery-item">
					<div class="thumbnail">
					<a class="thumbnail-link" data-toggle="tooltip" title="<?php echo $this->lang('Visualiser') ?>" data-image="<?php echo $this->model2('file', $image['file_id'])->path() ?>" data-title="<?php echo $image['title'] ?>" data-description="<?php echo $image['description'] ?>"><img class="img-responsive" src="<?php echo $this->model2('file', $image['thumbnail_file_id'])->path() ?>" alt="" /></a>
						<div class="actions">
