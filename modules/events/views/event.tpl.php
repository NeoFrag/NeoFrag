	...
	<div class="row vcenter">
		...
		<?php if ($data['match']['scores']): ?>
			<div class="text-center col-2 vcenter">
				<div class="well m-0"><h2 class="<?php echo $color ?> m-0"><?php echo $data['match']['scores'][0] ?>:<?php echo $data['match']['scores'][1] ?></h2></div>
			</div>
		<?php else: ?>
			<div class="text-center col-2 vcenter">
...
<div class="panel-body">
	...
	<?php if (count($data['rounds']) > 1): ?>
		...
		<div class="well well-sm<?php echo (($i+1) == count($data['rounds'])) ? ' m-0' : '' ?>">
			<div class="row vcenter">
