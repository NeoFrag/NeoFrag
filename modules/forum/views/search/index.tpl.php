<p class="pull-right"><?php echo icon('fas fa-comments').' <a href="'.url('forum/'.$forum_id.'/'.url_title($title)).'">'.$title.'</a> '.icon('fas fa-user').' '.($user_id ? $this->user->link($user_id, $username) : '<i>'.$this->lang('Visiteur').'</i>').' '.icon('far fa-clock').' '.time_span($date) ?></p>
