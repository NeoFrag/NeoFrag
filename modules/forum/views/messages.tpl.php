	...
	<tbody class="forum-content">
		...
		<tr>
			<td class="col-md-3 text-center">
				<br />
				<h4 class="no-margin"><?php echo $message['user_id'] ? $NeoFrag->user->link($message['user_id'], $message['username']) : '<i>Visiteur</i>'; ?></h4>
				<?php if ($message['user_id']) echo '<p>'.icon('fa-circle '.($message['online'] ? 'text-green' : 'text-gray')).' '.($message['admin'] ? 'Admin' : 'Membre').' '.($message['online'] ? 'en ligne' : 'hors ligne').'</p>'; ?>
