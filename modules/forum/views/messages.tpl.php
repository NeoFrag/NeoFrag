		...
		<tr>
			...
			<td class="text-left col-md-9">
				<div class="padding-top">
					...
					<a name="message_<?php echo $message['message_id']; ?>"></a><?php echo icon('fa-clock-o').' '.time_span($message['date']).' '.($data['last_message_read'] && $message['date'] <= $data['last_message_read'] ? icon('fa-comment-o').' '.$this->lang('message_read') : icon('fa-comment').' '.$this->lang('message_unread')); ?>
				</div>
				<hr />
