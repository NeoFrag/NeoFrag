...
<table class="table">
	...
	<tbody>
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-sign-in-alt  fa-rotate-90').' '.$this->lang('Inscrit depuis le') ?></b></td>
		...
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-history').' '.$this->lang('Dernière activité') ?></b></td>
			<td class="col-lg-9 col-md-8 col-7"><?php echo time_span($last_activity_date) ?></td>
		</tr>
		<?php endif ?>
		<?php if (!empty($date_of_birth)): ?>
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-birthday-cake').' '.$this->lang('Date de naissance') ?></b></td>
		...
		<?php if (!empty($sex)): ?>
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-'.$sex).' '.$this->lang('Sexe') ?></b></td>
			<td class="col-lg-9 col-md-8 col-7"><?php echo $this->lang($sex == 'male' ? 'Homme' : 'Femme') ?></td>
		</tr>
		<?php endif ?>
		<?php if (!empty($location)): ?>
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-map-marker-alt').' '.$this->lang('Localisation') ?></b></td>
			<td class="col-lg-9 col-md-8 col-7"><?php echo $location ?></td>
		</tr>
		<?php endif ?>
		<?php if (!empty($website)): ?>
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-globe').' '.$this->lang('Site web') ?></b></td>
			<td class="col-lg-9 col-md-8 col-7"><?php echo strtolink($website) ?></td>
		</tr>
		<?php endif ?>
		<?php if (!empty($quote)): ?>
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-bookmark').' '.$this->lang('Citation') ?></b></td>
			<td class="col-lg-9 col-md-8 col-7"><?php echo $quote ?></td>
		</tr>
		<?php endif ?>
		<?php if (!empty($signature)): ?>
		<tr>
			<td class="col-lg-3 col-md-4 col-5"><b><?php echo icon('fas fa-pencil-alt').' '.$this->lang('Signature') ?></b></td>
