	...
	<li class="list-group-item">
		<div class="pull-right">
			...
			<?php else: ?>
				...
				<span class="badge badge-default" data-toggle="tooltip" title="Pour intégrer l'équipe <?php echo $recruit['team_name'] ?>"><?php echo icon('fa-gamepad') ?></span>
				<?php endif ?>
				<span class="badge badge-default" data-toggle="tooltip" title="<?php echo ($recruit['size'] - $recruit['candidacies_accepted']) > 1 ? 'Postes' : 'Poste' ?>"><?php echo icon('fa-briefcase').' '.($recruit['size'] - $recruit['candidacies_accepted']) ?></span>
			<?php endif ?>
		</div>
