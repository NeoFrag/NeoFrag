		...
		<div id="navigation-options" class="tab-pane active" role="tabpanel">
			<div class="form-horizontal">
				<div class="form-group">
					<label for="settings-gallery" class="col-sm-3 control-label"><?php echo i18n('random_picture'); ?></label>
					<div class="col-sm-6">
						<select class="form-control" name="settings[gallery_id]" id="settings-gallery">
							<option value="0"<?php if ($data['gallery_id'] == 0) echo ' selected="selected"'; ?>><?php i18n('all_galleries'); ?></option>
