<ul class="list-inline m-0">
	<li class="list-inline-item"><?php echo icon('fa-sliders') ?></li>
	...
	<li class="list-inline-item"><a href="<?php echo url(($this->url->admin) ? 'admin/events/upcoming' : 'events/upcoming') ?>"><?php echo ($this->url->request == 'events/upcoming' || $this->url->request == 'events/upcoming/list' || $this->url->request == 'admin/events/upcoming') ? '<b>À jouer</b>' : 'À jouer' ?></a></li>
</ul>
