	...
	<div class="tab-content">
		<div id="partners-options" class="tab-pane active" role="tabpanel">
			<div class="form-horizontal">
				<input type="hidden" name="settings[id]" value="<?php echo $data['id']; ?>" />
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<select class="form-control" name="settings[display_style]" id="settings-display_style">
							<option value="light"<?php if ($data['display_style'] == 'light') echo ' selected="selected"'; ?>>Logo clair</option>
							<option value="dark"<?php if ($data['display_style'] == 'dark') echo ' selected="selected"'; ?>>Logo foncé</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input type="number" class="form-control" name="settings[display_height]" id="settings-display_height" value="<?php echo $data['display_height'] ? $data['display_height'] : '140'; ?>" />
