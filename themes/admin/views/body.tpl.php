		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="page-actions pull-right">
					...
					<?php NeoFrag()->js('help') ?>
					<a class="btn btn-outline btn-info btn-sm" href="<?php echo url($this->url->request) ?>" data-help="<?php echo 'admin/help/'.$this->output->module()->name.'/'.$module_method ?>"><?php echo icon('fa-life-bouy') ?><span class="hidden-sm"> <?php echo $this->lang('help') ?></span></a>
					<?php endif ?>
				</div>
			</div>
		</div>
