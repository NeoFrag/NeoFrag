<div class="row">
	<div class="col-md-4">
		<div class="caption text-center">
			<h6><?php echo i18n('transparent_background'); ?></h6>
		</div>
	...
	<div class="col-md-4">
		<div class="caption text-center">
			<h6><?php echo i18n('white_background'); ?></h6>
		</div>
	...
	<div class="col-md-4">
		<div class="caption text-center">
			<h6><?php echo i18n('light_background'); ?></h6>
		</div>
...
<div class="row">
	<div class="col-md-4">
		<div class="caption text-center">
			<h6><?php echo i18n('dark_background'); ?></h6>
		</div>
	...
	<div class="col-md-4">
		<div class="caption text-center">
			<h6><?php echo i18n('transparent_black_background'); ?></h6>
		</div>
	...
	<div class="col-md-4">
		<div class="caption text-center">
			<h6><?php echo i18n('orange_background'); ?></h6>
		</div>
