<div class="debugbar hidden-xs<?php if ($data['active']) echo ' active'; ?>">
	...
	<nav>
		...
		<div class="pull-right">
			<p class="hidden-sm"><?php echo '<span class="badge">'.(post() ? 'POST' : 'GET').'</span> '.implode(' ', array_map(function($a){ return '<span class="badge">'.$a.'</span>'; }, NeoFrag::loader()->router->segments)); ?></p>
