<ul class="nav navbar-nav <?php echo !empty($data['align']) ? $data['align'] : 'navbar-right'; ?>">
	...
	<?php else: ?>
		<li><p class="navbar-text"><a href="<?php echo url('user.html'); ?>"><?php echo $this->lang('create_account'); ?></a></p></li>
		<li><a href="<?php echo url('user.html'); ?>"><?php echo icon('fa-sign-in').' '.$this->lang('login'); ?></a></li>
	<?php endif; ?>
</ul>
