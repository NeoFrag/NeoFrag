				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<label class="radio-inline">
							<input type="radio" name="settings[align]" value="navbar-left"<?php if ($data['align'] != 'navbar-right') echo ' checked="checked"'; ?> /> à gauche
						</label>
						<label class="radio-inline">
							<input type="radio" name="settings[align]" value="navbar-right"<?php if ($data['align'] == 'navbar-right') echo ' checked="checked"'; ?> /> à droite
						</label>
					</div>
				</div>
			</div>
