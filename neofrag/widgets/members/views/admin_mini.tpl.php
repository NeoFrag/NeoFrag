				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<label class="radio-inline">
							<input type="radio" name="settings[align]" value="pull-left"<?php if ($data['align'] != 'pull-right') echo ' checked="checked"'; ?> /> à gauche
						</label>
						<label class="radio-inline">
							<input type="radio" name="settings[align]" value="pull-right"<?php if ($data['align'] == 'pull-right') echo ' checked="checked"'; ?> /> à droite
						</label>
					</div>
				</div>
			</div>
