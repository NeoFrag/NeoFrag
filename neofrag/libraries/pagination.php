...
class Pagination extends Library
{
	...
	{
		return '{base_url}'.implode('/', ($pos = array_search('page', $this->config->segments_url)) !== FALSE || ($pos = array_search('all', $this->config->segments_url)) !== FALSE ? array_slice($this->config->segments_url, 0, $pos) : $this->config->segments_url);
	}
