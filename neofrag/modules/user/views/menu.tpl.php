<div class="list-group">
	<a href="<?php echo url('user.html'); ?>" class="list-group-item<?php echo !isset($this->url->segments[1]) ? ' active' : ''; ?>"><?php echo icon('fa-user'); ?> Mon espace</a>
	<a href="<?php echo url('user/edit.html'); ?>" class="list-group-item<?php echo isset($this->url->segments[1]) && $this->url->segments[1] == 'edit' ? ' active' : ''; ?>"><?php echo icon('fa-cogs'); ?> Gérer mon compte</a>
