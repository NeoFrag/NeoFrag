	...
	$(function(){
		...
		$('.thumbnail .btn-danger').click(function(e){
			...
			if (!$(this).hasClass('disabled')){
				modal_theme('<?php echo i18n('theme_deletion'); ?>', '<?php echo i18n('theme_deletion_message'); ?>', '<button type="button" class="btn btn-danger" data-theme="'+$(this).parents('.thumbnail:first').data('theme')+'"><?php echo i18n('theme_deletion_message'); ?></button>', function(){
